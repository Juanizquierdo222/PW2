...
@app.route('/guardar_cambios/<id_personal>', methods=['POST'])
def guardar_cambios(id_personal):
    # Obtener los datos del formulario
    ...
    actualizar_usuario(id_personal, primer_nombre, apellido, correo_electronico, celular, contraseña, confirmar_contraseña, rol)
